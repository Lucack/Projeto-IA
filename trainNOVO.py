...
checkpoint_dir = 'checkpointNovoConfig'  # Ou onde seus arquivos de checkpoint estão armazenados
...
populacao.add_reporter(neat.Checkpointer(10,filename_prefix="checkpoint-"))

# Executando a evolução
ganhador = populacao.run(avaliarGenomas, 50)

# Salvando o melhor genoma
with open('checkpointNovoConfig/ganhador.pkl', 'wb') as output:
